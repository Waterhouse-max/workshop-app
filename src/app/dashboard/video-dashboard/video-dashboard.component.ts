  ...
  list: video[] = [
    {
      ...
      author:
        'Kyle Cordes, Lance Finney, Zachary Kipping, and David Moore',
      id: 'JINJQk7ggoo',
      viewDetails: [
    ...
    {
      title:
        'The Dangerous Temptation of Customizing Angular Material',
      author: 'Paul Spears',
      id: 'gSvxYv2VgHc',
      viewDetails: [
        { age: 17, region: 'North America', date: '2021-03-23' },
    ...
    },
    {
      ...
      author:
        'Kyle Cordes, Lance Finney, Zachary Kipping, and Paul Spears',
      id: 'P6KfzvEnItY',
      viewDetails: [
